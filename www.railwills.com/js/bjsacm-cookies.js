...
function DPlanshow(){
	...
	json.ad_PlanWait.push({num:DShow.num,carnum:DShow.carnum,startButton:DShow.startButton,endButton:DShow.endButton,startNum:DShow.startNum,endNum:DShow.endNum})
...
/*function SPlanShow(){
	...
	var time
	var route
	console.log(document.getElementById("beijing_stationtrack_RX").value)
	show.rs_Car.forEach(function(val,n){
		if(val=="01"){
			if(document.getElementById("RecOrderNum").innerHTML==""){
			    document.getElementById("RecOrderNum").innerHTML=show.order[n];
