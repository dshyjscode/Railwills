...
function Refresh(){
        ...
        if($.cookie("刷新界面").substr(4,1)==1){
        
           window.location.reload()
           var str=rePlaceStr($.cookie("刷新界面"),5,"2")
...
if(getCookie("网络连接").substr(3,1)=="2")
{
...
if(getCookie("网络连接").substr(5,1)=="2"){
...
if(getCookie("网络连接").substr(4,1)=="2"){
...
function TJLJ() {
	var str = rePlaceStr(getCookie("网络连接"),4,"1");
	setCookie("网络连接",str);
    alert("连接应用服务器成功");
	$("#lianjieyingyongfuwuqi").text("应用服务器已连接");
			var canvas = document.getElementById("canvas");
...
function TJCWZD() {
	if(getCookie("网络连接").substr(3,1)=="2"){
		var str = rePlaceStr(getCookie("网络连接"),5,"1");
		setCookie("网络连接",str);
    	alert("连接车务终端成功");
		$("#lianjiechewuzhongduan").text("车务终端已连接");
			var canvas = document.getElementById("canvas");
