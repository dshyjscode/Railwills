...
function getCookie_recurrent(){
	...
	//清空列表信息
    clearTable()
	setTimeout(getCookie_recurrent,1000);
}
...
function Recurrent_MapAndCar(map){
    ...
    var x,y,x1,x2,y1;
    var n,m;
    var signal=map.substr(69,12)
    var turnout=map.substr(140,4)
    var track=map.substr(235,20)
...
function Recurrent_car(car,turnout,previousTurnout){
    ...
    for(var i=0;i<car.length;i+=8){
        ...
        if(position!=0){
            ...
            if(coordinate[position].name.substr(0,1)=="N"){
                //小车复现
        ...
        if(previous!=null && coordinate[previous].name.substr(0,1)=="N" && previous!=position){
            //前一次小车消失
...
function nanjingcexiangguidao1(x,y,color,k){
...
function nanjingcexiangguidao2(x,y,color,k){
...
function nanjingcexiangguidao3(x,y,color,k){
...
function nanjingcexiangguidao4(x,y,color,k){
...
function guidaofuxian(x1,y1,x2,color,equipment,turnout){
    ...
    if(equipment=="1DG"){
        ...
        if (turnout.substr(0,1)=="1"){
            ...
            nanjingcexiangguidao1(x1+39,y1,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            nanjingcexiangguidao1(x1+44,y1-5,color,k)
            ...
            nanjingcexiangguidao1(x1+39,y1,color,l)
        ...
        if (turnout.substr(1,1)=="1"){
            nanjingcexiangguidao3(x1+39,y1+5,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            nanjingcexiangguidao3(x1+44,y1+10,color,k)
           ...
           juxingzhuguidao(x1,y1,x1+39,color)
            ...
            nanjingcexiangguidao3(x1+39,y1+5,color,l)
        ...
        if (turnout.substr(2,1)=="1"){
            nanjingcexiangguidao2(x1+13,y1-62,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1-60,x1+10,color)
            
            nanjingcexiangguidao2(x1+13,y1-62,color,k)
        }
            ...
            nanjingcexiangguidao2(x1+13,y1-62,color,l)
        }
        ...
        if (turnout.substr(3,1)=="1"){
            nanjingcexiangguidao4(x1+13,y1+62,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1+60,x1+10,color)
            
            nanjingcexiangguidao4(x1+13,y1+62,color,k)
        }
            ...
            nanjingcexiangguidao4(x1+13,y1+62,color,l)
        }
