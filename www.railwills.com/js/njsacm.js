...
function Refresh(){
        ...
        if($.cookie("刷新界面").substr(6,1)==1){
        
           window.location.reload()
           var str=rePlaceStr($.cookie("刷新界面"),7,"2")
...
if(getCookie("网络连接").substr(9,1)=="2")
{
...
if(getCookie("网络连接").substr(11,1)=="2"){
...
if(getCookie("网络连接").substr(10,1)=="2"){
...
function NJNZYYFWQ() {
	var str = rePlaceStr(getCookie("网络连接"),10,"1");
	setCookie("网络连接",str);
	alert("连接应用服务器成功");  
	$("#lianjieyingyongfuwuqi").text("应用服务器已连接");
			var canvas = document.getElementById("canvas");
...
function NJNZLS() {
	var str = rePlaceStr(getCookie("网络连接"),12,"1");
	setCookie("网络连接",str);
	alert("连接联锁成功");
	$("#lianjieliansuo").text("联锁已连接");
			var canvas = document.getElementById("canvas");
...
function NJNZCWZD() {
	if(getCookie("网络连接").substr(9,1)=="2"){	
		var str = rePlaceStr(getCookie("网络连接"),11,"1");
		setCookie("网络连接",str);
    	alert("连接车务终端成功");
		$("#lianjiechewuzhongduan").text("车务终端已连接");
		var canvas = document.getElementById("canvas");
