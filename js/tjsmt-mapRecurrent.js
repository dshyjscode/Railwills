...
function Recurrent_MapAndCar(map){
    ...
    var x,y,x1,x2,y1;
    var n,m;
    var signal=map.substr(41,12)
    var turnout=map.substr(126,6)
    var track=map.substr(189,22)
...
function Recurrent_car(car,turnout,previousTurnout){
    ...
    for(var i=0;i<car.length;i+=8){
        ...
        if(position!=0){
            ...
            if(coordinate[position].name.substr(0,1)=="T"){
                //小车复现
        ...
        if(previous!=null && coordinate[previous].name.substr(0,1)=="T" && previous!=position){
            //前一次小车消失
...
function tianjincexiangguidao1(x,y,color,k){
...
function tianjincexiangguidao10(x,y,color,k){
...
function tianjincexiangguidao3(x,y,color,k){
...
function tianjincexiangguidao12(x,y,color,k){
...
function tianjinchangcexiangguidao(x1,y1,x2,y2,color){
    var d=100;
    var c=1750;
	// 北京南站2/4号双动道岔绘制
    var canvas = document.getElementById("canvas");
...
function guidaofuxian(x1,y1,x2,color,equipment,turnout){
    ...
    if(equipment=="1DG"){
        ...
        if (turnout.substr(0,1)=="1"){
            ...
            tianjincexiangguidao1(x1+39,y1,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            tianjincexiangguidao1(x1+44,y1-5,color,k)
            ...
            tianjincexiangguidao1(x1+39,y1,color,l)
        ...
        if (turnout.substr(1,1)=="1"){
            ...
            tianjincexiangguidao3(x1+39,y1+5,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            tianjincexiangguidao3(x1+44,y1+10,color,k)
            ...
            tianjincexiangguidao3(x1+39,y1+5,color,l)
            
            juxingzhuguidao(x2-5,y1+60,x2+40,color)
        }
        
    }
    else if(equipment=="2-8DG"){
        if (turnout.substr(2,1)=="1" && turnout.substr(3,1)=="1"){
            tianjinchangcexiangguidao(1300-10.5,260+d-4.4,1353,282+d,"black")
            
            tianjinchangcexiangguidao(1353,282+d,1405+10.5,260+d-4.4,"black")
            
            juxingzhuguidao(x1,y1,x2,color)
            
            tianjinchangcexiangguidao(1300,260+d,1353,282+d,color)
            
            tianjinchangcexiangguidao(1353,282+d,1405,260+d,color)
        }
        else if(turnout.substr(3,1)=="2"){
            juxingzhuguidao(x1,y1,1300-10.5,color)
            
            juxingzhuguidao(1300-10.5+10,y1,x2,color)
            
            tianjinchangcexiangguidao(1300-10.5,260+d-4.4,1353,282+d,color)	
            ...
            juxingzhuguidao(x1,y1,1405+10.5-10,color)
            
            juxingzhuguidao(1405+10.5,y1,x2,color)
            
            tianjinchangcexiangguidao(1353,282+d,1405+10.5,260+d-4.4,color)	
        ...
        if (turnout.substr(4,1)=="1"){
            tianjincexiangguidao10(x1+13,y1-62,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1-60,x1+10,color)
            
            tianjincexiangguidao10(x1+13,y1-62,color,k)
        }
            ...
            tianjincexiangguidao10(x1+13,y1-62,color,l)
        }
            
		
    }
    else if(equipment=="4-6DG"){
         if (turnout.substr(2,1)=="1" && turnout.substr(3,1)=="1"){
            tianjinchangcexiangguidao(1353,282+d,1405+10.5,304+d+4.4,"black")
            
            tianjinchangcexiangguidao(1300-10.5,304+d+4.4,1353,282+d,"black")
            
            juxingzhuguidao(x1,y1,x2,color)
            
            tianjinchangcexiangguidao(1353,282+d,1405,304+d,color)
            
            tianjinchangcexiangguidao(1300,304+d,1353,282+d,color)	
        }
        else if(turnout.substr(2,1)=="2"){
            juxingzhuguidao(x1,y1,1300-10.5,color)
            ...
            tianjinchangcexiangguidao(1300-10.5,304+d+4.4,1353,282+d,color)	
            ...
            tianjinchangcexiangguidao(1353,282+d,1405+10.5,304+d+4.4,color)	
         ...
         if (turnout.substr(5,1)=="1"){
            ...
            tianjincexiangguidao12(x1+13,y1+62,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1+60,x1+10,color)
            
            tianjincexiangguidao12(x1+13,y1+62,color,k)
        }
            ...
            tianjincexiangguidao12(x1+13,y1+62,color,l)
        }
...
function xiaxingcexianxiaoche10(x,y,color){
    x=x+3
    y=y-3
    var canvas = document.getElementById("canvas");
    var context = canvas.getContext("2d");
...
function shangxingcexianxiaoche10(x,y,color){
    x=x+3
    y=y-3
    var canvas = document.getElementById("canvas");
    var context = canvas.getContext("2d");
...
function shangxingcexianxiaoche12(x,y,color){
    x=x-3
    y=y-3
    var canvas = document.getElementById("canvas");
    var context = canvas.getContext("2d");
...
function xiaxingcexianxiaoche12(x,y,color){
    x=x-3
    y=y-3
    ...
    if(equipment=="1DG"){ 
        ...
        if(turnout.substr(4,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche10(x1+13,y1-62,color)
               
            }
            else{
                shangxingcexianxiaoche10(x1+13,y1-62,color)
            }
        ...
        if(turnout.substr(5,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche12(x1+13,y1+62,color)
            }
            else{
                shangxingcexianxiaoche12(x1+13,y1+62,color)
            }
