...
function Recurrent_MapAndCar(map){
    ...
    var x,y,x1,x2,y1;
    var n,m;
    var signal=map.substr(55,12)
    var turnout=map.substr(134,4)
    var track=map.substr(213,20)
...
function Recurrent_car(car,turnout,previousTurnout){
    ...
    for(var i=0;i<car.length;i+=8){
        ...
        if(position!=0){
            ...
            if(coordinate[position].name.substr(0,1)=="J"){
                //小车复现
        ...
        if(previous!=null && coordinate[previous].name.substr(0,1)=="J" && previous!=position){
            //前一次小车消失
...
function jinancexiangguidao1(x,y,color,k){
...
function jinancexiangguidao2(x,y,color,k){
...
function jinancexiangguidao3(x,y,color,k){
...
function jinancexiangguidao4(x,y,color,k){
...
function guidaofuxian(x1,y1,x2,color,equipment,turnout){
    ...
    if(equipment=="1DG"){
        ...
        if (turnout.substr(0,1)=="1"){
            ...
            jinancexiangguidao1(x1+39,y1,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            jinancexiangguidao1(x1+44,y1-5,color,k)
            ...
            jinancexiangguidao1(x1+39,y1,color,l)
        ...
        if (turnout.substr(1,1)=="1"){
            jinancexiangguidao3(x1+39,y1+5,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            jinancexiangguidao3(x1+44,y1+10,color,k)
            ...
            jinancexiangguidao3(x1+39,y1+5,color,l)
        ...
        if (turnout.substr(2,1)=="1"){
            jinancexiangguidao2(x1+13,y1-62,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1-60,x1+10,color)
            
            jinancexiangguidao2(x1+13,y1-62,color,k)
        }
            ...
            jinancexiangguidao2(x1+13,y1-62,color,l)
        }
        ...
        if (turnout.substr(3,1)=="1"){
            jinancexiangguidao4(x1+13,y1+62,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1+60,x1+10,color)
            
            jinancexiangguidao4(x1+13,y1+62,color,k)
        }
            ...
            jinancexiangguidao4(x1+13,y1+62,color,l)
        }
    ...
    if(equipment=="1DG"){ 
        ...
        if(turnout.substr(2,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche2(x1+15,y1-62,color)
               
            }
            else{
                shangxingcexianxiaoche2(x1+15,y1-62,color)
            }
