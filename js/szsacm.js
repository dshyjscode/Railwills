...
function Refresh(){
        ...
        if($.cookie("刷新界面").substr(7,1)==1){
        
           window.location.reload()
           var str=rePlaceStr($.cookie("刷新界面"),8,"2")
...
if(getCookie("网络连接").substr(12,1)=="2")
{
...
if(getCookie("网络连接").substr(14,1)=="2"){
...
if(getCookie("网络连接").substr(13,1)=="2"){
...
function SZBYYFWQ() {
	var str = rePlaceStr(getCookie("网络连接"),13,"1");
	setCookie("网络连接",str);
    alert("连接应用服务器成功");
	$("#lianjieyingyongfuwuqi").text("应用服务器已连接");
			var canvas = document.getElementById("canvas");
...
function SZBLS() {
	var str = rePlaceStr(getCookie("网络连接"),15,"1");
	setCookie("网络连接",str);
    alert("连接联锁成功");
	$("#lianjieliansuo").text("联锁已连接");
			var canvas = document.getElementById("canvas");
...
function SZBCWZD() {
	if(getCookie("网络连接").substr(12,1)=="2"){
	var str = rePlaceStr(getCookie("网络连接"),14,"1");
	setCookie("网络连接",str);
    alert("连接车务终端成功");
	$("#lianjiechewuzhongduan").text("车务终端已连接");
			var canvas = document.getElementById("canvas");
