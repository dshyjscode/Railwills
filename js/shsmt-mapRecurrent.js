...
function Recurrent_MapAndCar(map){
    ...
    var n,m;
    var x,y,x1,x2,y1;
    var signal=map.substr(97,16)
    var turnout=map.substr(152,9)
    var track=map.substr(279,24)
...
function Recurrent_car(car,turnout,previousTurnout){
    ...
    for(var i=0;i<car.length;i+=8){
        ...
        if(position!=0){
            ...
            if(coordinate[position].name.substr(0,1)=="H"){
                //小车复现
        ...
        if(previous!=null && coordinate[previous].name.substr(0,1)=="H" && previous!=position){
            //前一次小车消失
...
function shanghaicexiangguidao5and9(x,y,color,k){
...
function shanghaicexiangguidao2and6(x,y,color,k){
...
function shanghaicexiangguidao7and11(x,y,color,k){
...
function shanghaicexiangguidao4and8(x,y,color,k){
...
function shanghaichangcexiangguidao(x1,y1,x2,y2,color){
    var d=100;
	var c=9173;
	// 上海1/3号双动道岔绘制
    var canvas = document.getElementById("canvas");
...
function guidaofuxian(x1,y1,x2,color,equipment,turnout){
    ...
    if(equipment=="3DG"){
        if (turnout.substr(0,1)=="1"){
            shanghaichangcexiangguidao(813,282+d,860+9.5,282+d-4.2,"black")
            
            juxingzhuguidao(x1,y1,x2,color)
            
            shanghaichangcexiangguidao(813,282+d,860,261+d,color)
        }
        else if(turnout.substr(0,1)=="2"){
            juxingzhuguidao(x1,y1,860+9.5-10,color)
            
            juxingzhuguidao(860+9.5,y1,x2,color)
            
            shanghaichangcexiangguidao(813,282+d,860+9.5,282+d-4.2,color)
        }
            
        
    }
	else if(equipment=="1DG"){
        if (turnout.substr(0,1)=="1"){
            shanghaichangcexiangguidao(765-9.5,303+d+4.2,813,282+d,"black")
            
            juxingzhuguidao(x1,y1,x2,color)
            
            shanghaichangcexiangguidao(765,303+d,813,282+d,color)
        }
        else if(turnout.substr(0,1)=="2"){
            juxingzhuguidao(x1,y1,765-9.5,color)
            
            juxingzhuguidao(765-9.5+10,y1,x2,color)
            
            shanghaichangcexiangguidao(765-9.5,303+d+4.2,813,282+d,color)
        }
        ...
        if (turnout.substr(1,1)=="1"){
            ...
            shanghaicexiangguidao5and9(x1+28,y1,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            shanghaicexiangguidao5and9(x1+33,y1-5,color,k)
            
            juxingzhuguidao(x1+85,y1-60,x2,color)
        }
        else if(turnout.substr(1,1)=="2"){
            juxingzhuguidao(x1,y1,x1+28,color)
            
            juxingzhuguidao(x1+38,y1,x2,color)
            
            shanghaicexiangguidao5and9(x1+28,y1,color,l)
    ...
    else if(equipment=="9DG"){
        
        
        if (turnout.substr(3,1)=="1"){
            shanghaicexiangguidao5and9(x1+56,y1,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            shanghaicexiangguidao5and9(x1+61,y1-5,color,k)
            
            juxingzhuguidao(x2+5,y1-60,x2+40,color)
        }
        else if(turnout.substr(3,1)=="2"){
            juxingzhuguidao(x1,y1,x1+56,color)
            
            juxingzhuguidao(x1+66,y1,x2,color)
            
            shanghaicexiangguidao5and9(x1+56,y1,color,l)
        ...
        if (turnout.substr(2,1)=="1"){
            shanghaicexiangguidao7and11(x1+28,y1+5,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            shanghaicexiangguidao7and11(x1+33,y1+10,color,k)
            ...
            shanghaicexiangguidao7and11(x1+28,y1+5,color,l)
            
            juxingzhuguidao(x1+85,y1+60,x2,color)
        }
        
    }
    else if(equipment=="11DG"){
        if (turnout.substr(4,1)=="1"){
            shanghaicexiangguidao7and11(x1+56,y1+5,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            shanghaicexiangguidao7and11(x1+61,y1+10,color,k)
            ...
            shanghaicexiangguidao7and11(x1+56,y1+5,color,l)
        ...
        if (turnout.substr(5,1)=="1"){
            shanghaicexiangguidao2and6(x1+14,y1-61,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-31,y1-60,x1+11,color)
            
            shanghaicexiangguidao2and6(x1+14,y1-61,color,k)  
        }
        else if(turnout.substr(5,1)=="2"){
            juxingzhuguidao(x1,y1,x1+14+l-10,color)
            
            juxingzhuguidao(x1+14+l,y1,x2,color)
            
            juxingzhuguidao(x1-31,y1-60,x1+11,color)
            
            shanghaicexiangguidao2and6(x1+14,y1-61,color,l)
        }
        ...
        if (turnout.substr(7,1)=="1"){
            shanghaicexiangguidao2and6(x1-5,y1-62,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1-60,x1-7,color)
            
            shanghaicexiangguidao2and6(x1-5,y1-62,color,k)
        }
        else if(turnout.substr(7,1)=="2"){
            juxingzhuguidao(x1,y1,x1-5+l-10,color)
            
            juxingzhuguidao(x1-5+l,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1-60,x1-7,color)
            
            shanghaicexiangguidao2and6(x1-5,y1-62,color,l)
        }
        
    }
    else if(equipment=="4DG"){
        if (turnout.substr(6,1)=="1"){
            shanghaicexiangguidao4and8(x1+14,y1+61,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-31,y1+60,x1+11,color)
            
            shanghaicexiangguidao4and8(x1+14,y1+61,color,k)
        }
            ...
            shanghaicexiangguidao4and8(x1+14,y1+61,color,l)
        }
        
    }
    else if(equipment=="8DG"){
        if (turnout.substr(8,1)=="1"){
            shanghaicexiangguidao4and8(x1-5,y1+62,"black",l)
            
            juxingzhuguidao(x1,y1,x2,color)
            
            juxingzhuguidao(x1-40,y1+60,x1-7,color)
            
            shanghaicexiangguidao4and8(x1-5,y1+62,color,k)
        }
            ...
            shanghaicexiangguidao4and8(x1-5,y1+62,color,l)
        }
...
function xiaxingcexianxiaoche5and9(x,y,color){
    x=x-3
    y=y-3
...
function shangxingcexianxiaoche5and9(x,y,color){
...
function xiaxingcexianxiaoche2and6(x,y,color){
    x=x+3
    y=y-3
    var canvas = document.getElementById("canvas");
    var context = canvas.getContext("2d");
...
function shangxingcexianxiaoche2and6(x,y,color){
    x=x+3
    y=y-3
    var canvas = document.getElementById("canvas");
    var context = canvas.getContext("2d");
...
function shangxingcexianxiaoche7and11(x,y,color){
    x=x+3
    y=y-3
    var canvas = document.getElementById("canvas");
    var context = canvas.getContext("2d");
...
function xiaxingcexianxiaoche7and11(x,y,color){
    x=x+3
    y=y-3
    var canvas = document.getElementById("canvas");
    var context = canvas.getContext("2d");
...
function shangxingcexianxiaoche4and8(x,y,color){
    x=x-3
    y=y-3
    var canvas = document.getElementById("canvas");
    var context = canvas.getContext("2d");
...
function xiaxingcexianxiaoche4and8(x,y,color){
    x=x-3
    y=y-3
    ...
    if(equipment=="3DG"){
        ...
        if(turnout.substr(1,1)==1){ 
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche1and5(x1+33,y1-5,color)
               
            }
            else{
                shangxingcexianxiaoche1and5(x1+33,y1-5,color)
            }
        }
    }
    else if(equipment=="9DG"){
        ...
        if(turnout.substr(3,1)==1){
           ...
           if(parseInt(carNum)%2=="1"){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche1and5(x1+61,y1-5,color)
               
            }
            else{
                shangxingcexianxiaoche1and5(x1+61,y1-5,color) 
            }
        }
        ...
        if(turnout.substr(2,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche3and7(x1+33,y1+10,color)
               
            }
            else{
                shangxingcexianxiaoche3and7(x1+33,y1+10,color)
            }
        }
    }
    else if(equipment=="11DG"){
        ...
        if(turnout.substr(3,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche3and7(x1+61,y1+10,color)
               
            }
            else{
                shangxingcexianxiaoche3and7(x1+61,y1+10,color)
            }
        }
    }
    else if(equipment=="2DG"){
        ...
        if(turnout.substr(5,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche6and10(x1+14,y1-61,color)
               
            }
            else{
                shangxingcexianxiaoche6and10(x1+14,y1-61,color)
            }
        ...
        if(turnout.substr(7,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche6and10(x1-5,y1-62,color)
               
            }
            else{
                shangxingcexianxiaoche6and10(x1-5,y1-62,color)
            }
        ...
        if(turnout.substr(6,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche8and12(x1+14,y1+61,color)
               
            }
            else{
                shangxingcexianxiaoche8and12(x1+14,y1+61,color)
            }
        ...
        if(turnout.substr(8,1)==1){
            ...
            if(parseInt(carNum)%2=="1"){
                ...
                xiaxingcexianxiaoche8and12(x1-5,y1+62,color)
               
            }
            else{
                shangxingcexianxiaoche8and12(x1-5,y1+62,color)
            }
        }
    }
    else {
